...
export default function OnlyMobileSupportModal() {
  ...
  return (
    <Modal className="nostr-modal" open={onlyMobileSupportedVisible} title={null} footer={null} onCancel={onCancel}>
      <Row justify="center">
        <p className="nostr-modal-content">
          Lightning Network and Taproot receive assets and send assets are not supported on mobile currently, please go
          to the Web to operate.
        </p>
